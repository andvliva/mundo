<?php
class Slider_Tours extends ET_Builder_Module_Blog {
     function init() {
    	parent::init();
        $this->name = __( 'Slider Tours', 'liva-divi' );
        $this->slug = 'et_pb_slider_tours';
       	$this->fb_support = true;
       	$this->whitelisted_fields[] = 'post_type';
       	$this->whitelisted_fields[] = 'type_tour';
...
// 		$this->global_settings_slug = 'et_pd_custom_post_slider';
        ...
        $fields['type_tour'] = array(
				'label'           => esc_html__( 'Type tour', 'et_builder' ),
				'type'            => 'select',
				'option_category' => 'color_option',
				'options'         => array(
					'travel_style'  => esc_html__( 'Travel style', 'et_builder' ),
					'departures_month' => esc_html__( 'Departures month', 'et_builder' ),
				),
				'toggle_slug'     => 'main_content',
				'description'     => esc_html__( 'Choose type display of list tour' , 'et_builder' ),
			);
        return $fields;
    }
