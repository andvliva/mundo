<?php
class Custom_Slider extends ET_Builder_Module {
	function init() {
		$this->name            = esc_html__( 'Custom Slider', 'liva-divi' );
		$this->slug            = 'et_pb_slider_owlcarousel';
		$this->fb_support      = true;
		$this->child_slug      = 'et_pb_slide_owlcarousel';
		...
		$this->main_css_element = '%%order_class%%.et_pb_slider owlcarousel2';

		$this->options_toggles = array(
			'general'  => array(
				'toggles' => array(
					'elements'    => esc_html__( 'Elements', 'liva-divi' ),
					'background'  => esc_html__( 'Background', 'liva-divi' ),
				),
			),
			'advanced' => array(
				'toggles' => array(
					'layout'     => esc_html__( 'Layout', 'liva-divi' ),
				),
			),
			'custom_css' => array(
				'toggles' => array(
					'animation' => array(
						'title'    => esc_html__( 'Animation', 'liva-divi' ),
						'priority' => 90,
					),
				),
			),
		...
		$this->custom_css_options = array(
			...
			'slide_controllers' => array(
				'label'    => esc_html__( 'Slide Controllers', 'liva-divi' ),
				'selector' => '.et-pb-controllers',
			),
			'slide_active_controller' => array(
				'label'    => esc_html__( 'Slide Active Controller', 'liva-divi' ),
			...
			'slide_arrows' => array(
				'label'    => esc_html__( 'Slide Arrows', 'liva-divi' ),
	...
	function get_fields() {
		$fields = array(
			'show_arrows'         => array(
				'label'           => esc_html__( 'Show Arrows', 'liva-divi' ),
				'type'            => 'yes_no_button',
				...
				'description'     => esc_html__( 'This setting will turn on and off the navigation arrows.', 'liva-divi' ),
			),
			'show_pagination' => array(
				'label'             => esc_html__( 'Show Controls', 'liva-divi' ),
				'type'              => 'yes_no_button',
				'option_category'   => 'configuration',
				'options'           => array(
					'on'  => esc_html__( 'Yes', 'liva-divi' ),
				...
				'toggle_slug'       => 'elements',
				'description'       => esc_html__( 'This setting will turn on and off the circle buttons at the bottom of the slider.', 'liva-divi' ),
			),
			'show_content_on_mobile' => array(
				'label'           => esc_html__( 'Show Content On Mobile', 'liva-divi' ),
				'type'            => 'yes_no_button',
			...
			'show_cta_on_mobile' => array(
				'label'           => esc_html__( 'Show CTA On Mobile', 'liva-divi' ),
				'type'            => 'yes_no_button',
				'option_category' => 'layout',
				'options'         => array(
					'on'  => esc_html__( 'Yes', 'liva-divi' ),
			...
			'show_image_video_mobile' => array(
				'label'           => esc_html__( 'Show Image / Video On Mobile', 'liva-divi' ),
				'type'            => 'yes_no_button',
				'option_category' => 'layout',
				'options'         => array(
					'off' => esc_html__( 'No', 'liva-divi' ),
			...
			'disabled_on' => array(
				'label'           => esc_html__( 'Disable on', 'liva-divi' ),
				'type'            => 'multiple_checkboxes',
				'options'         => array(
					'phone'   => esc_html__( 'Phone', 'liva-divi' ),
					'tablet'  => esc_html__( 'Tablet', 'liva-divi' ),
					'desktop' => esc_html__( 'Desktop', 'liva-divi' ),
				),
				'additional_att'  => 'disable_on',
				'option_category' => 'configuration',
				'description'     => esc_html__( 'This will disable the module on selected devices', 'liva-divi' ),
				'tab_slug'        => 'custom_css',
				'toggle_slug'     => 'visibility',
			),
			'admin_label' => array(
				...
				'type'        => 'text',
				'description' => esc_html__( 'This will change the label of the module in the builder for easy identification.', 'liva-divi' ),
				'toggle_slug' => 'admin_label',
			),
			'module_id' => array(
				'label'           => esc_html__( 'CSS ID', 'liva-divi' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'tab_slug'        => 'custom_css',
				'toggle_slug'     => 'classes',
			...
			'module_class' => array(
				'label'           => esc_html__( 'CSS Class', 'liva-divi' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'tab_slug'        => 'custom_css',
				'toggle_slug'     => 'classes',
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$output = sprintf(
			'<div%4$s class="et_pb_module owlcarousel owl-theme et_pb_slider%1$s%3$s%5$s" data-options="%7$s">
