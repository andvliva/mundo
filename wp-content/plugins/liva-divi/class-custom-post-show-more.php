<?php
class Custom_Post_Show_More extends Custom_Post {
     function init() {
    	parent::init();
        $this->name = __( 'Custom Post Show More', 'liva-divi' );
        $this->slug = 'et_pb_custom_post_show_more';
...
// 		$this->global_settings_slug = 'et_pd_custom_post_slider';
    ...
    function shortcode_callback( $atts, $content = null, $function_name) {
        ...
        <div class="dropdown">
        <span class="sort-by">'.__("Sort by: ",'liva-divi').'</span>
                        <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">'.__("Most popular",'liva-divi').'<span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <li><a href="#" id="most_popular" data-name="'.__("Most popular",'liva-divi').'" data-value="ASC">'.__("Most popular",'liva-divi').'</a></li>
                            <li><a href="#" id="price" class="sort-by-price low-to-high" data-name="'.__("Low to high",'liva-divi').'" data-value="ASC">'.__("Low to high",'liva-divi').'</a></li>
                            <li><a href="#" id="price" class="sort-by-price high-to-low" data-name="'.__("High to low",'liva-divi').'" data-value="DESC">'.__("High to low",'liva-divi').'</a></li>
                        </ul>
                    </div>';
        $results_found = '<div class="results-found">'.__('Results Found:','liva-divi').'<b class="total_posts"> '. $total_posts.'<b></div><div class="clear-both"></div></div>';                
		if ( !empty($posts) ) {
			if ( 'off' === $fullwidth ) {
