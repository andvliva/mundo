<?php
class Custom_Post extends ET_Builder_Module_Blog {
     function init() {
    	parent::init();
        $this->name = __( 'Custom post', 'liva-divi' );
...
// 		$this->global_settings_slug = 'et_pd_custom_post_slider';
    ...
    function shortcode_callback( $atts, $content = null, $function_name ) {
       ...
       //	$tester = get_post_meta(1859,'view_home',true);d($tester);
      // print_r($args);exit();
       // print_r($post); exit;
	...
	<?php
        ...
        $posts =  apply_filters('custom_posts_style_1', $posts, $module_id);
		ob_end_clean();
