...
if (!function_exists('cc_tour_filter_custom_rewrite')) {
	function cc_tour_filter_custom_rewrite() {
    	...
    	add_rewrite_rule(
    		'^tourtesten/filter/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/?$',
    		'index.php?page_id=25914&type_of_tour=$matches[1]&category_destination=$matches[2]&travel_style=$matches[3]&tour_guide=$matches[4]&duration=$matches[5]&price_range=$matches[6]&per_page=$matches[7]&sort_by=$matches[8]&search=$matches[9]&departure=$matches[10]',
    		'top'
    	);

    	add_rewrite_rule(
    		'^es/tourtestes/filter/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/?$',
    		'index.php?page_id=25919&lang=es&type_of_tour=$matches[1]&category_destination=$matches[2]&travel_style=$matches[3]&tour_guide=$matches[4]&duration=$matches[5]&price_range=$matches[6]&per_page=$matches[7]&sort_by=$matches[8]&search=$matches[9]&departure=$matches[10]',
    		'top'
    	);

    	add_rewrite_rule(
    		'^pt/tourtestpt/filter/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/([^/]*)/?$',
    		'index.php?page_id=25923&lang=pt&type_of_tour=$matches[1]&category_destination=$matches[2]&travel_style=$matches[3]&tour_guide=$matches[4]&duration=$matches[5]&price_range=$matches[6]&per_page=$matches[7]&sort_by=$matches[8]&search=$matches[9]&departure=$matches[10]',
    		'top'
    	);
