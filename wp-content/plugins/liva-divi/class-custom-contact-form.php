...
class Custom_Contact_Form extends ET_Builder_Module {
	function init() {
		$this->name            = esc_html__( 'Custom Contact Form', 'et_builder' );
		$this->slug            = 'et_pb_custom_contact_form';
		$this->fb_support      = true;
		$this->child_slug      = 'et_pb_custom_contact_field';
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
        ...
        $content = apply_filters( 'content_sustom_contact_form',$content,$module_id);  
		if ( $et_contact_error ) {
